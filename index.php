...
<body>
    <ul class="side-nav" id="mobile-demo">
		...
		<li><a class="waves-effect" href="./Construction.html">快速下载</a></li>
		<li><a class="waves-effect" href="./Construction.html">分类下载</a></li>
		<li><a class="waves-effect" href="./Construction.html">站点源码</a></li>
		<li><a class="waves-effect" href="./Construction.html">返回顶部</a></li>
	</ul><!-- 侧边导航栏-->
		...
		<nav>
     		<div class="nav-wrapper #f06292 pink lighten-3 b0c" id="b0c">
				...
				<ul class="right hide-on-med-and-down section upshang">
        			...
        			<li><a href="./Construction.html">站点源码</a></li>
